...
def test_add_patient_log():
    ...
    patient2 = add_patient_log("999", "Happy", 2, "Feeling better")
    assert patient2 is None  # Non-existent patient should return None

def test_register_staff():
    # Register a new staff member
    staff = register_staff("200", "pass200", "General", "Dr. Smith")
    assert staff is not None
    assert staff.user_id == "200"

    staff_dup = register_staff("200", "pass200", "Specialist", "Dr. Jones")
    assert staff_dup is None  # Duplicate staff registration should fail
...
def test_assign_staff_to_patient():
    ...
    result_nonexistent_patient = assign_staff_to_patient("999", "200")
    assert result_nonexistent_patient is False  # Non-existent patient should return False

    result_nonexistent_staff = assign_staff_to_patient("123", "999")
